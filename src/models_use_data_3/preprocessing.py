...
print("存储数据中：")
print('位置：../../data/data_3/train_preprocessed1.csv & test_preprocessed1.csv')
...
train_df.to_csv('../../data/data_3/train_preprocessed1.csv',encoding='gbk',index=False)
test_df.to_csv('../../data/data_3/test_preprocessed1.csv',encoding='gbk',index=False)
