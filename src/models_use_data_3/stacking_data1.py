...
# 保存新的训练集和测试集
print("\n存储数据中：")
print('位置：../../data/data_3/z_train1.csv & z_test1.csv')
z_train_pd = pd.DataFrame(z_train, columns=['XGB', 'RF'])
z_test_pd = pd.DataFrame(z_test, columns=['XGB', 'RF'])
z_train_pd.to_csv('../../data/data_3/z_train1.csv',encoding='gbk',index=False)
z_test_pd.to_csv('../../data/data_3/z_test1.csv',encoding='gbk',index=False)
