...
def sum_columns(start,end, all_features_df):
    ...
    sum_feat.columns = ['var' + str(start) + '~' + str(end-1)]
...
train_df.to_csv('../../data/data_5/train_preprocessed2.csv', encoding='gbk', index=False)
test_df.to_csv('../../data/data_5/test_preprocessed2.csv', encoding='gbk', index=False)
